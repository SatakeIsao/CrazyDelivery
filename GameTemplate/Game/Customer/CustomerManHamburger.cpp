...
CustomerManHamburger::CustomerManHamburger()
{
}
...
void CustomerManHamburger::Render(RenderContext& rc)
{
...
void CustomerManHamburger::Init()
{
	...
	//モデルの初期化
	m_modelRender.Init("Assets/ModelData/Customer/Man/Man_Hamburger.tkm", m_manAnimClips, enAnimClip_Num, enModelUpAxisY, true, false);
...
void CustomerManHamburger::UpdateMarkEffect()
{
	//クールタイムの経過時間を更新
...
void CustomerManHamburger::UpdateCoolTime()
{
	// OnUpdateでリセット判定
