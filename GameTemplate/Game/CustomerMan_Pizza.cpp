...
CustomerMan_Pizza::CustomerMan_Pizza()
{
}
...
void CustomerMan_Pizza::Init()
{
	...
	//モデルの初期化
	m_customerMan_Pizza.Init("Assets/ModelData/Customer/Man/Man_Pizza.tkm", m_manAnimClips, enAnimClip_Num, enModelUpAxisY, true, false);
